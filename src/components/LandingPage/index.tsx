          ...
          >
            <div className="flex flex-col items-center">
              ...
              <div className="flex space-x-2 mb-4">
                <button
                  className="bg-gray-200 text-gray-800 rounded-full w-6 h-6 sm:w-8 sm:h-8 flex justify-center items-center"
              ...
              <button
                ...
                className="bg-black text-white rounded-md px-3 py-2 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium"
              >
                Add to Cart
              </button>
            </div>
